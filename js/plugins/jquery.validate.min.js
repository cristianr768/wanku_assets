    ...
    h.extend(h.fn, {
                        ...
                        this.on("submit.validate", function (i) {
                            function t() {
                                ...
                                return (
                                    ...
                                    (s.submitButton && (t = h("<input type='hidden'/>").attr("name", s.submitButton.name).val(h(s.submitButton).val()).appendTo(s.currentForm)),
        ...
        rules: function (t, e) {
            var i,
                ...
                l = this[0];
            if (t)
                switch (((i = h.data(l.form, "validator").settings), (s = i.rules), (r = h.validator.staticRules(l)), t)) {
                    case "add":
                        h.extend(r, h.validator.normalizeRule(e)), delete r.messages, (s[l.name] = r), e.messages && (i.messages[l.name] = h.extend(i.messages[l.name], e.messages));
                        break;
                    case "remove":
                        return e
                            ? ((o = {}),
                              h.each(e.split(/\s/), function (t, e) {
                                  (o[e] = r[e]), delete r[e], "required" === e && h(l).removeAttr("aria-required");
                              }),
                              o)
                            : (delete s[l.name], r);
                }
            return (
                (n = h.validator.normalizeRules(h.extend({}, h.validator.classRules(l), h.validator.attributeRules(l), h.validator.dataRules(l), h.validator.staticRules(l)), l)).required &&
                    ((a = n.required), delete n.required, (n = h.extend({ required: a }, n)), h(l).attr("aria-required", "true")),
                n.remote && ((a = n.remote), delete n.remote, (n = h.extend(n, { remote: a }))),
                n
            );
        },
    }),
        ...
        h.extend(h.validator, {
            defaults: {
                ...
                onkeyup: function (t, e) {
                    (9 === e.which && "" === this.elementValue(t)) || -1 !== h.inArray(e.keyCode, [16, 17, 18, 20, 35, 36, 37, 38, 39, 40, 45, 144, 225]) || ((t.name in this.submitted || t === this.lastElement) && this.element(t));
                },
                onclick: function (t) {
            ...
            prototype: {
                init: function () {
                    ...
                    h.each(this.settings.groups, function (i, t) {
                        ...
                        h(this.currentForm).find("[required], [data-rule-required], .required").attr("aria-required", "true");
                },
                form: function () {
                ...
                element: function (t) {
                    var e = this.clean(t),
                        ...
                        s = !0;
                    return (
                        void 0 === (this.lastElement = i) ? delete this.invalid[e.name] : (this.prepareElement(i), (this.currentElements = h(i)), (s = !1 !== this.check(i)) ? delete this.invalid[i.name] : (this.invalid[i.name] = !0)),
                        h(t).attr("aria-invalid", !s),
                ...
                resetForm: function () {
                    h.fn.resetForm && h(this.currentForm).resetForm(), (this.submitted = {}), (this.lastElement = null), this.prepareForm(), this.hideErrors();
                    var t,
                        e = this.elements().removeData("previousValue").removeAttr("aria-invalid");
                ...
                check: function (e) {
                    ...
                    for (i in r) {
                        ...
                        try {
                            if ("dependency-mismatch" === (t = h.validator.methods[i].call(this, o, e, s.parameters)) && 1 === n) {
                                a = !0;
                                continue;
                            }
                ...
                showLabel: function (t, e) {
                    var i,
                        ...
                        n = this.errorsFor(t),
                        a = this.idOrName(t),
                        o = h(t).attr("aria-describedby");
                    n.length
                        ? (n.removeClass(this.settings.validClass).addClass(this.settings.errorClass), n.html(e))
                        : ((i = n = h("<" + this.settings.errorElement + ">")
                              .attr("id", a + "-error")
                          ...
                          this.settings.wrapper &&
                              (i = n
                                  ...
                                  .parent()),
                          this.labelContainer.length ? this.labelContainer.append(i) : this.settings.errorPlacement ? this.settings.errorPlacement(i, h(t)) : i.insertAfter(t),
                          n.is("label")
                              ? n.attr("for", a)
                              : 0 === n.parents("label[for='" + a + "']").length &&
                                ((r = n.attr("id").replace(/(:|\.|\[|\]|\$)/g, "\\$1")),
                                o ? o.match(new RegExp("\\b" + r + "\\b")) || (o += " " + r) : (o = r),
                                h(t).attr("aria-describedby", o),
                                (s = this.groups[t.name]) &&
                                    h.each(this.groups, function (t, e) {
                                        e === s && h("[name='" + t + "']", this.currentForm).attr("aria-describedby", n.attr("id"));
                                    }))),
                        !e && this.settings.success && (n.text(""), "string" == typeof this.settings.success ? n.addClass(this.settings.success) : this.settings.success(n, t)),
                ...
                destroy: function () {
                    this.resetForm(), h(this.currentForm).off(".validate").removeData("validator");
                },
            },
            ...
            attributeRules: function (t) {
                ...
                for (e in h.validator.methods) (i = "required" === e ? ("" === (i = t.getAttribute(e)) && (i = !0), !!i) : r.attr(e)), this.normalizeAttributeRule(s, n, e, i);
            ...
            dataRules: function (t) {
                var e,
                    ...
                    r = h(t),
                    n = t.getAttribute("type");
                for (e in h.validator.methods) (i = r.data("rule" + e.charAt(0).toUpperCase() + e.substring(1).toLowerCase())), this.normalizeAttributeRule(s, n, e, i);
                return s;
            },
            ...
            methods: {
                ...
                creditcard: function (t, e) {
                    ...
                    for (i = t.length - 1; 0 <= i; i--) (s = t.charAt(i)), (n = parseInt(s, 10)), a && 9 < (n *= 2) && (n -= 9), (r += n), (a = !a);
                    return r % 10 == 0;
                },
                ...
                equalTo: function (t, e, i) {
                    ...
                    return (
                        this.settings.onfocusout &&
                            s.off(".validate-equalTo").on("blur.validate-equalTo", function () {
                                h(e).valid();
                            }),
                        t === s.val()
                    );
                ...
                remote: function (n, a, t) {
                    ...
                    var o,
                        e,
                        l = this.previousValue(a);
                    return (
                        this.settings.messages[a.name] || (this.settings.messages[a.name] = {}),
                        (l.originalMessage = this.settings.messages[a.name].remote),
                        (this.settings.messages[a.name].remote = l.message),
                        (t = "string" == typeof t ? { url: t } : t),
                        l.old === n
                            ? l.valid
                            : ((l.old = n),
                              (o = this).startRequest(a),
                              ((e = {})[a.name] = n),
                              h.ajax(
                                  h.extend(
                                      !0,
                                      {
                                          ...
                                          success: function (t) {
                                              var e,
                                                  ...
                                                  s,
                                                  r = !0 === t || "true" === t;
                                              (o.settings.messages[a.name].remote = l.originalMessage),
                                                  r
                                                      ? ((s = o.formSubmitted), o.prepareElement(a), (o.formSubmitted = s), o.successList.push(a), delete o.invalid[a.name], o.showErrors())
                                                      : ((e = {}), (i = t || o.defaultMessage(a, "remote")), (e[a.name] = l.message = h.isFunction(i) ? i(n) : i), (o.invalid[a.name] = !0), o.showErrors(e)),
                                                  (l.valid = r),
                                                  o.stopRequest(a, r);
                                          },
                                      },
    ...
    h.ajaxPrefilter
        ...
        : ((s = h.ajax),
          (h.ajax = function (t) {
              ...
              return "abort" === e ? (r[i] && r[i].abort(), (r[i] = s.apply(this, arguments)), r[i]) : s.apply(this, arguments);
          }));
});
