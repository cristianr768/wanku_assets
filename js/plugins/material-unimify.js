(isWindows = -1 < navigator.platform.indexOf("Win")),
    isWindows
        ? (0 != $(".sidebar").length && new PerfectScrollbar(".sidebar"),
          0 != $(".sidebar-wrapper").length && new PerfectScrollbar(".sidebar-wrapper"),
          0 != $(".main-panel").length && new PerfectScrollbar(".main-panel"),
          0 != $(".main").length && new PerfectScrollbar("main"),
...
$(document).ready(function () {
    ...
    (md = {
        ...
        initDashboardPageCharts: function () {
            var e, a, t;
            (0 == $("#dailySalesChart").length && 0 == $("#completedTasksChart").length && 0 == $("#websiteViewsChart").length) ||
                ((dataDailySalesChart = { labels: ["M", "T", "W", "T", "F", "S", "S"], series: [[12, 17, 7, 17, 23, 18, 38]] }),
                (optionsDailySalesChart = { lineSmooth: Chartist.Interpolation.cardinal({ tension: 0 }), low: 0, high: 50, chartPadding: { top: 0, right: 0, bottom: 0, left: 0 } }),
                ...
                (a = new Chartist.Line("#completedTasksChart", dataCompletedTasksChart, optionsCompletedTasksChart)),
